...
void StreamServerComponent::dump_config() {
    ...
    // Fix fuer ESPHome >= 2026: network::get_use_address() existiert nicht mehr
...
void StreamServerComponent::accept() {
    ...
    // Fix fuer ESPHome >= 2026: getpeername() ohne Argumente gibt es nicht mehr.
    // Der Identifier dient nur der Log-Ausgabe.
    std::string identifier = "client";
