        ...
        public:
            ...
            void handleStatus(ESPSystemStatusMessage message) {
                ...
                if (low_flow_mode_ != nullptr) {
                    // Fix: Rueckmeldung war invertiert. set_low_flow_mode() sendet bei "an"
                    // den Modus PUMP_OFF_SOLENOID_OPEN - der Schalter muss also "an" melden,
                    // wenn genau dieser Modus aktiv ist. Im Original stand hier "!=", wodurch
                    // der Schalter dauerhaft "an" zeigte, solange KEIN Low Flow aktiv war.
